          ...
          <Tabs defaultValue="mistral">
            ...
            <TabsContent value="mistral" className="space-y-4">
              <div>
                ...
                <p className="bg-gray-50 p-4 rounded-md whitespace-pre-wrap font-mono text-sm">
                  <small>API key save on your browser localstorage, We don't have access to it.</small>
                </p>
                <Input
                  id="mistral-api-key"
                  type="password"
